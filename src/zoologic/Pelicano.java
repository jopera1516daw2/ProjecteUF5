...
/**
 * classe Pelican que extendeix de Volador
 */
public class Pelicano extends Volador{
    /**
    * atributs instancies
    */
    private static Pelicano instance1;
    private static Pelicano instance2;
    private static Pelicano instance3;
    private static Pelicano instance4;
    private static Pelicano instance5;
    /**
    * mètode estatic que crea una instància de Pelican si no existeix y retorna la instància en qüestió
    */
     public static Pelicano getInstance1(){
        if(instance1==null){
            instance1=new Pelicano("macho",0,false);
        }
        return instance1;
    }
    /**
    * mètode estatic que crea una instància de Pelican si no existeix y retorna la instància en qüestió
    */
    public static Pelicano getInstance2(){
        if(instance2==null){
            instance2=new Pelicano("hembra",0,false);
        }
        return instance2;
    }
    /**
    * mètode estatic que crea una instància de Pelican si no existeix y retorna la instància en qüestió
    */
    public static Pelicano getInstance3(){
        if(instance3==null){
            instance3=new Pelicano("macho",0,false);
        }
        return instance3;
    }
    /**
    * mètode estatic que crea una instància de Pelican si no existeix y retorna la instància en qüestió
    */
    public static Pelicano getInstance4(){
        if(instance4==null){
            instance4=new Pelicano("macho",0,false);
        }
        return instance4;
    }
    /**
    * mètode estatic que crea una instància de Pelican si no existeix y retorna la instància en qüestió
    */
    public static Pelicano getInstance5(){
        if(instance5==null){
            instance5=new Pelicano("macho",0,false);
        }
        return instance5;
    }
    /**
    ...
    */
    public Pelicano(String genero, int edat, boolean alimentado) {
        super( genero, edat, alimentado);
    }
    /**
    * mètode per eliminar de la llista d'animals voladors una instància de Pelican
    * @param instance indica la instancia de Pelican que es vol eliminar
    */
    public void eliminar(Pelicano instance){
        Volador VoladorList = Volador.getInstance();
        VoladorList.remove(instance);
    }
    /**
    * mètode de la vida de la instancia de Pelican. Es tracta d'una funció que es repeteix cada 10 segons.
    ...
    * @param instance indica la instancia de Pelican que viurà.
    */
    public void vida(Pelicano instance){ 
        ...
        timer.scheduleAtFixedRate(new TimerTask()
            {
                public void run()
                {
                    ...
                    System.out.println(Jugando.getPelicanos());
                }
            }, 0, 10000);
    }
}