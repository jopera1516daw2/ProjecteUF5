...
/**
 * classe Elefant que extendeix de Terrestre
 */
public class Elefante extends Terrestre{
    /**
    * atributs instancies
    */
    private static Elefante instance1;
    private static Elefante instance2;
    private static Elefante instance3;
    private static Elefante instance4;
    private static Elefante instance5;
    /**
    * mètode estatic que crea una instància de Elefant si no existeix y retorna la instància en qüestió
    */
    public static Elefante getInstance1(){
        if(instance1==null){
            instance1=new Elefante("macho",0,false);
        }
        return instance1;
    }
    /**
    * mètode estatic que crea una instància de Elefant si no existeix y retorna la instància en qüestió
    */
    public static Elefante getInstance2(){
        if(instance2==null){
            instance2=new Elefante("hembra",0,false);
        }
        return instance2;
    }
    /**
    * mètode estatic que crea una instància de Elefant si no existeix y retorna la instància en qüestió
    */
    public static Elefante getInstance3(){
        if(instance3==null){
            instance3=new Elefante("macho",0,false);
        }
        return instance3;
    }
    /**
    * mètode estatic que crea una instància de Elefant si no existeix y retorna la instància en qüestió
    */
    public static Elefante getInstance4(){
        if(instance4==null){
            instance4=new Elefante("macho",0,false);
        }
        return instance4;
    }
    /**
    * mètode estatic que crea una instància de Elefant si no existeix y retorna la instància en qüestió
    */
    public static Elefante getInstance5(){
        if(instance5==null){
            instance5=new Elefante("macho",0,false);
        }
        return instance5;
    }
    /**
    ...
    */
    public Elefante(String genero, int edat, boolean alimentado) {
        super( genero, edat, alimentado);
    }
    /**
    * mètode per eliminar de la llista d'animals terrestres una instància de Elefant
    * @param instance indica la instancia de Elefant que es vol eliminar
    */
    public void eliminar(Elefante instance){
        Terrestre TerrestreList = Terrestre.getInstance();
        TerrestreList.remove(instance);
    }
    /**
    * mètode de la vida de la instancia de Elefant. Es tracta d'una funció que es repeteix cada 10 segons.
    ...
    * @param instance indica la instancia de Elefant que viurà.
    */
    public void vida(Elefante instance){ 
        ...
        timer.scheduleAtFixedRate(new TimerTask()
            {
                public void run()
                {
                    ...
                    System.out.println(Jugando.getElefantes());
                }
            }, 0, 10000);
    }
}