...
/**
 * classe Tortuga que extendeix de Acuatic
 */
public class Tortuga extends Acuatico{
    private static Tortuga instance1;
    private static Tortuga instance2;
    private static Tortuga instance3;
    private static Tortuga instance4;
    private static Tortuga instance5;
    /**
    * atributs instancies
    */
    public static Tortuga getInstance1(){
        if(instance1==null){
            instance1=new Tortuga("macho",0,false);
        }
        return instance1;
    }
    /**
    * mètode estatic que crea una instància de Tortuga si no existeix y retorna la instància en qüestió
    */
    public static Tortuga getInstance2(){
        if(instance2==null){
            instance2=new Tortuga("hembra",0,false);
        }
        return instance2;
    }
    /**
    * mètode estatic que crea una instància de Tortuga si no existeix y retorna la instància en qüestió
    */
    public static Tortuga getInstance3(){
        if(instance3==null){
            instance3=new Tortuga("macho",0,false);
        }
        return instance3;
    }
    /**
    * mètode estatic que crea una instància de Tortuga si no existeix y retorna la instància en qüestió
    */
    public static Tortuga getInstance4(){
        if(instance4==null){
            instance4=new Tortuga("macho",0,false);
        }
        return instance4;
    }
    /**
    * mètode estatic que crea una instància de Tortuga si no existeix y retorna la instància en qüestió
    */
    public static Tortuga getInstance5(){
        if(instance5==null){
            instance5=new Tortuga("macho",0,false);
        }
        return instance5;
    }
    /**
    ...
    */
    public Tortuga(String genero, int edat, boolean alimentado) {
        super( genero, edat, alimentado);
    }
    /**
    * mètode per eliminar de la llista d'animals acuatics una instància de Tortuga
    * @param instance indica la instancia de Tortuga que es vol eliminar
    */
    public void eliminar(Tortuga instance){
        Acuatico AcuaticoList = Acuatico.getInstance();
        AcuaticoList.remove(instance);
    }
    /**
    * mètode de la vida de la instancia de Tortuga. Es tracta d'una funció que es repeteix cada 10 segons.
    ...
    * @param instance indica la instancia de Tortuga que viurà.
    */
    public void vida(Tortuga instance){ 
        ...
        timer.scheduleAtFixedRate(new TimerTask()
            {
                public void run()
                {
                    ...
                    System.out.println(Jugando.getTortugas());
                }
            }, 0, 10000);
    }
}